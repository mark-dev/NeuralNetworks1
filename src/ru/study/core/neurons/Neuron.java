...
public abstract class Neuron {
    ...
    public static byte NEURON_TYPE_FINAL = 2;
    public static byte NEURON_TYPE_MEDIUM = 3;
    public static byte NEURON_TYPE_VIRTUAL = 4;

    private HashSet<NeuroInput> in = new HashSet<NeuroInput>();
